...
const propTypes = {
    ...
    itemButtonStyle: ViewPropTypes.style,
    itemButtonTextStyle: Text.propTypes.style,
    itemStyle: ViewPropTypes.style,
    itemTextStyle: Text.propTypes.style,
    itemContainerStyle: ViewPropTypes.style,
    childrenViewStyle: ViewPropTypes.style,
    openButtonStyle: ViewPropTypes.style,
    closeContainerStyle: ViewPropTypes.style,
    closeStyle: ViewPropTypes.style,
    closeTextStyle: Text.propTypes.style,
...
export default class MenuList extends React.Component {
    ...
    _renderMenuList = () => {
        ...
        return (
            <TouchableWithoutFeedback key={'menuListPicker' + (componentIndex++)} accessible={false} onPress={() => this.close()}>
